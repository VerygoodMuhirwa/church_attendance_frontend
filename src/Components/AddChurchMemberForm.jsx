...
const AddChurchMemberForm = () => {
    const token = JSON.parse(localStorage.getItem("token"))
    const [username, setUsername] = useState("")
    const [email, setEmail] = useState("")
    const [Class, setClass] = useState("Y1")
    const [family, setFamily] = useState("Family 1")
    ...
    const handleFormSubmit = async(e) => {
        ...
        const res = await axios.post("https://verygood-attendance-church.onrender.com/api/v1/members/addMember", formData, {
            headers: {
        ...
        <div className="register-form-container">
            ...
            <form action="" className="register-form">
                ...
                <select name="userclass" id="userclass" value={family} onChange={(e) => setFamily(e.target.value)}>
                    <option value="Family 1" selected>Family 1</option>
